...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2020 at 05:09 AM
...
INSERT INTO `customer` (`id`, `name`, `gmail`, `subject`, `message`) VALUES
(1, 'ngoc duc', 'nhanmasitinh@gmail.com', 'car', 'mua'),
(2, 'nhan ma', 'nhanmasitinh@gmail.com', 'w', 'w'),
(3, 'nhan ma', 'nhanmasitinh@gmail.com', 's', 'đ'),
(4, 'nhan ma', 'nhanmasitinh@gmail.com', 's', 'ss'),
(5, 'nhan ma', 'nhanmasitinh@gmail.co', 'y', 'yy'),
(6, 'nhan', 'ma', ' nga', 'rr'),
(7, 'nhan', 'ma', ' nga', 'rr'),
(8, 'nhan', 'sd', 'd', 'sd'),
(9, 'nhan ma', 'ngo', 'a', 's');
...
INSERT INTO `customer1` (`id`, `name`, `adress`, `daterantel`, `datereturn`, `namecar`, `gmail`, `numberphone`) VALUES
(1, 'datereturn', 'd', '2020-11-13', '2020-11-23', 'datereturn', 's', 's'),
(2, 'adress', 'd', '2020-11-11', '2020-11-11', '23', 's', 'ee'),
(3, '1', '2', '2020-11-05', '2020-11-10', '23', '333', '444'),
(4, 'đ', 'đ', '2020-11-05', '2020-11-12', 'd', 'nhan@gmail.com', '0932423');
...
(1, 'Võ Ngọc Đức', 'CO-Founder', 'Tốt nghiệp đại Mỏ địa chất. Có 3 năm kinh nghiệm trong quản trị doanh nghiệp, 2 năm kinh nghiệm trong tảng TMDT,đầu tư kinh doanh.', './assets/img/ngocduc.jpg'),
(2, 'Phạm Quang Hậu', 'CO-Founder', 'Tốt nghiệp đại học Mỏ địa chất. Có 3 năm kinh nghiệm trong ngành ô tô.', './assets/img/hau.jpg'),
(3, 'Bùi thao Ly', 'CO-Founder', 'Tốt nghiệp đại học Mỏ địa chất. Có 3 năm kinh nghiệm trong mảng sale marketing.', './assets/img/ly.jpg'),
(4, 'Diệu Linh', 'CO-Founder', 'Tốt nghiệp đại Mỏ địa chất. Có 3 năm kinh nghiệm trong quản trị doanh nghiệp, 2 năm kinh nghiệm trong tảng TMDT,đầu tư kinh doanh.', './assets/img/linh.jpg'),
(5, 'Nguyễn Tiến Đạt', 'CO-Founder', 'Tốt nghiệp đại Mỏ địa chất. Có 3 năm kinh nghiệm trong quản trị doanh nghiệp, 2 năm kinh nghiệm trong tảng TMDT,đầu tư kinh doanh.', './assets/img/dat.jpg');
...
(1, 'Võ Ngọc Đức', '2020-11-14', 'Tôi rất hài lòng về chất lượng dịch vụ và xe bên bạn', './assets/img/depositphotos_108108494-stock-photo-happy-client-giving-car-keys.jpg'),
(2, 'Diệu Linh', '2020-10-16', 'Tôi cực kỳ thích cách chăm sóc khách hàng của bên bạn', './assets/img/happy-female-client-sitting-new-comfortable-automobile_7502-2305.jpg'),
(3, 'Nguyễn Tiến Đạt', '2020-09-15', 'OTO bên bạn rất tuyệt vời.Cảm ơn', './assets/img/inline_image_preview.jpg');
